...
static void MYSNAT_help(void)
{
	printf(
"MYSNAT target options:\n"
" --to-source [<ipaddr>[-<ipaddr>]][:port[-port]]\n"
"				Address to map source to.\n"
"[--random] [--persistent]\n");
}

static const struct xt_option_entry MYSNAT_opts[] = {
...
static void MYSNAT_print(const void *ip, const struct xt_entry_target *target,
                       int numeric)
{
...
static void MYSNAT_save(const void *ip, const struct xt_entry_target *target)
{
	const struct ipt_natinfo *info = (const void *)target;
	unsigned int i = 0;
...
static struct xtables_target mysnat_tg_reg = {
	.name		= "MYSNAT",
	...
	.help		= MYSNAT_help,
	.x6_parse	= MYSNAT_parse,
	.print		= MYSNAT_print,
	.save		= MYSNAT_save,
	.x6_options	= MYSNAT_opts,
};
